...
<body>
    <header class="header">
        ...
        <div class="right">
            <!-- <button class="btn"><a href="file5.html">Edit</a> </button> -->
            <button class="btn02"><a href="creat.php">Create</a></button>
            <button class="btn02"><a href="logout.php">Logout</a></button>
            <!-- <button class="btn"><a href="file7.html">Delete</a></button> -->
        </div>
        <div >
            <div class="box">
                <h2>Discription Payable</h2>
                <ul>
                    <li><span>1</span>A</li>
                    <li><span>2</span>B</li>
                    <li><span>3</span>X</li>
            ...
            <div class="box" id="dv1">
                ...
                <ul>
                    ...
                    <li><span>4</span>54367 <button class="btn"><a href="fedit.php">Edit</a> </button><button class="btn"><a href="delet.php">Delete</a> </button></li>
